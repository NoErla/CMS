                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="">
                        <a <#if menu="article">class="active"</#if> href="${BASE_PATH}/manage/article/list.htm"> <i
                                class="icon-book"></i> <span>文章列表</span></a>
                    </li>
                <#if SESSION_ADMIN.isAdmin>
                    ...
                    <li class="">
                        <a <#if menu="folder">class="active"</#if> href="${BASE_PATH}/manage/folder/list.htm"> <i
                                class="icon-folder-open"></i> <span>目录列表</span></a>
                    </li>
                    <li class="">
                        <a <#if menu="message">class="active"</#if> href="${BASE_PATH}/manage/guestbook/list.htm"> <i
