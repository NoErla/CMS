	...
	<section class="wrapper">
			...
			<h2 align="center">${article.title }</h2>
				<div class="blog-content" >
					<div class="content-title"><i>摘要：${article.summary }</i></div>
					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<input type="hidden" style="font-size:15px;width: 300px;"
								class="form-control" name="userId" placeholder="用户Id"
								id="userId" value="${SESSION_USER.userId}"> </input> <input
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" style="font-size:15px;width: 300px;"
										class="form-control" name="name" placeholder="文章标题" id="name">
									</input>
								</div>
							</div>
					</div>
